...
describe('Controller', () => {
  ...
  describe('readOne', () => {
    ...
    it('car readOne falha não encontra id', async () => {
      const responseReadOne = await chai.request(app).get(`/cars/111aaaaa3a94a2894aa3f9e7`)
  ...
  describe('update', () => {
    ...
    it('car update sucesso', async () => {
     const responseUpdate = await chai.request(app).put(`/cars/${mocks[0]._id}`).send(carExemple)
    expect(responseUpdate.status).to.be.equal(200)
    })
    it('car update falha não encontra id', async () => {
      const responseUpdate = await chai.request(app).put(`/cars/111aaaaa3a94a2894aa3f9e7`).send(carExemple)
  ...
  describe('delete', () => {
    ...
    it('car delete falha não encontra id', async () => {
      const responseDelete = await chai.request(app).delete(`/cars/111aaaaa3a94a2894aa3f9e7`)
  ...
  describe('MotorcycleController', () => {
    const motorcycleModel = new MotorcycleModel()
     describe('create', () => {
       it('create motorcycles', async () => {
        const responseCreate = await chai.request(app).post('/motorcycles').send(motorcycles)
       expect(responseCreate.status).to.be.equal(201)
       })
     })
     describe('read', () => {
    ...
    describe('readOne', () => {
      ...
      it('motorcycles readOne sucesso', async () => {
       const responseReadOne = await chai.request(app).get(`/motorcycles/${mocks[0]._id}`)
      expect(responseReadOne.status).to.be.equal(200)
      })
      it('motorcycles readOne falha não encontra id', async () => {
        const responseReadOne = await chai.request(app).get(`/motorcycles/111aaaaa3a94a2894aa3f9e7`)
       expect(responseReadOne.status).to.be.equal(404)
       })
    ...
    describe('update', () => {
      ...
      it('motorcycles update sucesso', async () => {
       const responseUpdate = await chai.request(app).put(`/motorcycles/${mocks[0]._id}`).send(motorcycles)
      expect(responseUpdate.status).to.be.equal(200)
      })
      it('motorcycles update falha não encontra id', async () => {
        const responseUpdate = await chai.request(app).put(`/motorcycles/111aaaaa3a94a2894aa3f9e7`).send(motorcycles)
       expect(responseUpdate.status).to.be.equal(404)
       })
       it('motorcycles update falha id não é hexadecimal', async () => {
        const responseUpdate = await chai.request(app).put(`/motorcycles/0`).send(motorcycles)
       expect(responseUpdate.status).to.be.equal(400)
       })
    })
    describe('delete', () => {
      ...
      it('motorcycles delete sucesso', async () => {
       const responseDelete = await chai.request(app).delete(`/motorcycles/${mocks[0]._id}`)
      expect(responseDelete.status).to.be.equal(204)
      })
      it('motorcycles delete falha não encontra id', async () => {
        const responseDelete = await chai.request(app).delete(`/motorcycles/111aaaaa3a94a2894aa3f9e7`)
       expect(responseDelete.status).to.be.equal(404)
       })
